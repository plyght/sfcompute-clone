(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
    ...
    e.s([
      "ContactLink",
      0,
      function ({ className: e, children: a, onClick: n, ...s }) {
  ...
  (e) => {
    ...
    e.s([
      ...
      function () {
        let e = (0, n.useRouter)(),
          [l, o] = (0, s.useState)(!0);
        return (0, t.jsx)(a.AnimatePresence, {
          onExitComplete: () => e.push(i.LINKS.home),
          children: l && (0, t.jsx)(r.ContactOverlay, { onClose: () => o(!1) }),
        });
      },
    ]);
  },
      ...
      function ({ jobs: e }) {
        ...
        (0, r.useEffect)(() => {
          ...
          r.forEach((r) => {
            ...
            (r.addEventListener("pointerenter", i), l.push(() => r.removeEventListener("pointerenter", i)));
          });
          let o = () => {
        ...
        let s = e.length > 0 && e.some((t) => t.department !== e[0]?.department);
        return (0, t.jsxs)("div", {
          children: [
                      ...
                      (0, t.jsxs)(
                        "a",
                        {
                          ...
                          children: [
                            ...
                            s && (0, t.jsx)("span", { className: i.default.cat, children: e.department }),
                          ],
                        },
                        e.id,
                      ),
  ...
  (e) => {
    ...
    e.s([
      "InlineLink",
      0,
      function ({ href: e, children: s, external: l, className: o, id: c }) {
        if (e === a.LINKS.contact && !l) return (0, t.jsx)(r.ContactLink, { className: (0, i.cn)(n, o), children: s });
        let d = e.startsWith("#")
          ? (t) => {
              ...
              let e = u.filter((e) => e.id),
                t = new IntersectionObserver(
                  (e) => {
                    ...
                    if (t[0]) {
                      let e = u.find((e) => e.id === t[0].target.id);
                      e && r(e.n);
