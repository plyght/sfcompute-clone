(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e) => {
        ...
        (0, r.useEffect)(() => {
          !(function (e = { debug: !0 }) {
            ...
            ((n.src = r),
              ...
              o() && !1 === e.debug && (n.dataset.debug = "false"),
        ...
        { route: u, path: d } =
          ...
          a
            ? {
                ...
                })(o, Object.keys(a).length ? a : Object.fromEntries(s.entries())),
                path: o,
              }
            : { route: null, path: o });
    ...
    e.s([
      ...
      0,
      function (e) {
        return r.default.createElement(r.Suspense, { fallback: null }, r.default.createElement(u, { ...e }));
      },
    ]);
  },
  957215,
  (e) => {
          ...
          if (n.current) e.route && n.current(e.route);
            ...
            let r = (function (e = {}) {
              ...
              return (
                (n.src = r),
                (n.defer = !0),
                (n.dataset.sdkn = "@vercel/speed-insights" + (e.framework ? `/${e.framework}` : "")),
    ...
    e.s([
      ...
      0,
      function (e) {
        return r.default.createElement(r.Suspense, { fallback: null }, r.default.createElement(i, { ...e }));
      },
    ]);
  },
  743962,
  (e) => {
    e.v((t) => Promise.all(["static/immutable/chunks/228d-qgtn4-yh.js"].map((t) => e.l(t))).then(() => t(777728)));
  },
]);
