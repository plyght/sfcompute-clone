(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    let n = e.r(271645);
    function l(e, t, r) {
      let [l, u] = (0, n.useState)(() => ({ tree: e, cacheNode: t, stateKey: r, next: null }));
      ...
      for (; null !== d && o < 1; ) {
        ...
        {
          o++;
          let e = { tree: d.tree, cacheNode: d.cacheNode, stateKey: d.stateKey, next: null };
          ((s.next = e), (s = e));
        }
        d = d.next;
      }
  ...
  (e, t, r) => {
    ...
    class s extends u.default.Component {
      ...
      static getDerivedStateFromError(e) {
        if ((0, o.isHTTPAccessFallbackError)(e)) return { triggeredStatus: (0, o.getAccessFallbackHTTPStatus)(e) };
        throw e;
      }
    ...
    function i({ notFound: e, forbidden: t, unauthorized: r, children: n }) {
      ...
      return e || t || r
        ? (0, l.jsx)(s, { pathname: o, notFound: e, forbidden: t, unauthorized: r, missingSlots: c, children: n })
  ...
  (e, t, r) => {
                  ...
                  o = () => {
                    ...
                    return (
                      null === n &&
                        ...
                        (l = t),
                        (n =
                          !Number.isFinite((a = Number.parseFloat((u = getComputedStyle(r).scrollPaddingTop)))) || a < 0
                            ? 0
                            : u.endsWith("px")
                              ? a
                              : u.endsWith("%")
    ...
    function x({ tree: e, segmentPath: t, debugNameContext: r, cacheNode: n, params: l, url: u, isActive: a }) {
      let s,
  ...
  (e, t, r) => {
    ...
    function n(e, t = {}) {
      ...
      ((r.style.scrollBehavior = "auto"), t.dontForceLayout || r.getClientRects(), e(), (r.style.scrollBehavior = l));
    }
    (e.i(247167),
      Object.defineProperty(r, "__esModule", { value: !0 }),
